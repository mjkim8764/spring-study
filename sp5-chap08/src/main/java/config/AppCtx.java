...
public class AppCtx {
    ...
    public DataSource dataSource() {
        ...
        ds.setUsername("root");
        ds.setPassword("1234");
        ds.setInitialSize(10);   // setInitialSize : Connection Pool 을 초기화할 때 생성할 초기 Connection 수, default : 10
        ds.setMaxActive(100);    // setMaxActive :  Pool 에서 가져올 수 있는 최대 Connection 수, default : 100
